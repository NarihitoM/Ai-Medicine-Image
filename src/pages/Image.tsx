    ...
    return (
        <>
            ...
            <div className="h-screen flex flex-col gap-3 justify-center items-center">
                ...
                <div className="w-auto p-10 bg-white shadow-[0_0_10px_0_blue,0_0_20px_0_blue] rounded-lg flex flex-col gap-5">
                    <label
                        htmlFor="fileUpload"
                    ...
                    <h1 className="text-red-600 font-bold text-2xl">PLEASE INPUT CLEAR IMAGE.</h1>
